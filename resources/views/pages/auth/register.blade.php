    ...
    <div class="relative z-10 px-2">
        <div class="mt-5 ml-2 flex flex-col gap-y-1.5">
            <div class="flex gap-x-1.5 items-center">
                <h1 class="font-jomhuria font-bold text-xl text-black">Register</h1>
                <i data-feather="user-plus" width="25" height="25" class="text-black font-bold"></i>
            </div>
            <p class="font-outfit font-normal">Silahkan Mendaftar di <span class="font-outfit font-semibold">BULIKAKAN</span></p>
        </div>

        <div class="mt-2 flex flex-col justify-center items-center">
            <img src="{{ asset('logo/loop-nobg.png') }}" width="210" alt="logo bulikakan">
            <h2 class="font-jomhuria font-bold text-biruPrimary">Daftarkan Akun Anda</h2>
        </div>

        <form action="{{ route('register.submit') }}" method="POST" class="mt-4 flex justify-center">
            @csrf
        ...
        <div class="flex items-center justify-center my-4">
            ...
            <span class="mx-2 text-gray-500 text-sm font-jomhuria">Atau Daftar Dengan</span>
            <hr class="w-1/4 border-gray-300">
        </div>
        
        <div class="flex justify-center mb-4">
            <a href="/auth-google-redirect" class="flex items-center gap-2 px-4 py-2 rounded-md shadow hover:shadow-md transition duration-200">
        ...
        <div class="text-center">
            <p class="text-sm font-jomhuria text-gray-600">Sudah punya akun? 
                <a href="{{ route('login') }}" class="text-biruPrimary font-semibold hover:underline">Login</a>
            </p>
        </div>
    </div>
</div>
