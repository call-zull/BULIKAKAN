...
@section('title', 'Password Berubah')

@section('content')
<div class="relative h-screen bg-white flex justify-center md:items-center px-4 py-10 overflow-hidden">
    ...
    <div class="relative z-10 flex flex-col items-center text-center mt-36 max-w-sm w-full md:mt-0">
        ...
        <div class="flex flex-col items-center gap-y-1.5 mb-5">
            <h1 class="text-[#1E232C] font-jomhuria font-bold text-2xl md:text-3xl lg:text-4xl">Password Changed</h1>
