                ...
                <div class="w-full md:w-1/2 space-y-4">
                    ...
                    <div x-data="lokasi">
                        <div class="mb-2">
                            ...
                            <select x-model="provinsi_id" @change="getKabupaten()" class="w-full p-2 border border-gray-300 rounded-xl">
                                <option value="">-- Pilih Provinsi --</option>
                                <template x-for="prov in provinsi" :key="prov.id">
                                    <option :value="prov.id" x-text="prov.name" :selected="prov.name === provinsi_nama"></option>
                                </template>
                            </select>
                        </div>
                        ...
                        <div class="mb-2" x-show="kabupaten.length > 0">
                            ...
                            <select x-model="kabupaten_id" @change="getKecamatan()" class="w-full p-2 border border-gray-300 rounded-xl">
                                <option value="">-- Pilih Kabupaten/Kota --</option>
                                <template x-for="kab in kabupaten" :key="kab.id">
                                    <option :value="kab.id" x-text="kab.name" :selected="kab.name === kabupaten_nama"></option>
                                </template>
                            </select>
                        </div>
                        ...
                        <div class="mb-2" x-show="kecamatan.length > 0">
                            ...
                            <select x-model="kecamatan_id" @change="getKelurahan()" class="w-full p-2 border border-gray-300 rounded-xl">
                                <option value="">-- Pilih Kecamatan --</option>
                                <template x-for="kec in kecamatan" :key="kec.id">
                                    <option :value="kec.id" x-text="kec.name" :selected="kec.name === kecamatan_nama"></option>
                                </template>
                            </select>
                        </div>
                        ...
                        <div class="mb-4" x-show="kelurahan.length > 0">
                            ...
                            <select name="kelurahan" x-model="kelurahan_id" class="w-full p-2 border border-gray-300 rounded-xl">
                                <option value="">-- Pilih Kelurahan --</option>
                                <template x-for="kel in kelurahan" :key="kel.id">
                                    <option :value="kel.name" x-text="kel.name" :selected="kel.name === kelurahan_nama"></option>
                                </template>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="selesai"
                                ...
                                <option value="1" {{ $pengumuman->selesai ? 'selected' : '' }}>Selesai/Ditemukan</option>
                            </select>
                        </div>
