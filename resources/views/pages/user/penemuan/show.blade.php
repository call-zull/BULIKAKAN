<x-app-layout title="Detail Penemuan">
                    ...
                    <div @click.away="open = false" class="bg-white rounded-lg p-6 w-full max-w-sm shadow-lg">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <a href="https://wa.me/?text={{ $shareText }}%20{{ $shareUrl }}" target="_blank"
                                class="bg-green-500 text-white px-4 py-2 flex items-center justify-center gap-x-1 rounded hover:bg-green-600 transition text-center">
                            ...
                            <a href="https://www.facebook.com/sharer/sharer.php?u={{ $shareUrl }}" target="_blank"
                                class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition flex items-center justify-center gap-x-1 text-center">
    ...
    <script>
        function copyCaption() {
            const caption = `Saya menemukan barang: {{ $pengumuman->judul }}.\n\nCek info lengkapnya di:\n{{ route('penemuan.show', $pengumuman->id) }}\n\nJika ini milik Anda, silakan hubungi saya.`;
